...
models:
  reasoning:
    path: /home/james/kinver-hub/models/DeepSeek-R1-Distill-Qwen-32B-Q4_K_M.gguf
    hf_model_id: deepseek-ai/DeepSeek-R1-Distill-Qwen-32B
  coder:
    path: /home/james/kinver-hub/models/qwen25-coder-32b-q4_k_m.gguf
    hf_model_id: Qwen/Qwen2.5-Coder-32B-Instruct
  architect:
    path: /home/james/kinver-hub/models/qwen3-32b-instruct-q4_k_m.gguf
    hf_model_id: Qwen/Qwen3-32B-Instruct
    overrides:
      max_tokens: 8192          # cap a 32B model for VRAM headroom
  professional:
    path: /home/james/kinver-hub/models/qwen25-72b-instruct-q4_k_m.gguf
    hf_model_id: Qwen/Qwen2.5-72B-Instruct
  creative:
    path: /home/james/kinver-hub/models/llama-3.3-70b-instruct-q4_k_m.gguf
    hf_model_id: meta-llama/Llama-3.3-70B-Instruct
  scholar:
    path: /home/james/kinver-hub/models/qwen3-30b-a3b-instruct-q4_k_m.gguf
    hf_model_id: Qwen/Qwen3-30B-A3B-Instruct
  worker:
    path: /home/james/kinver-hub/models/qwen25-9b-instruct-q5_k_m.gguf
    hf_model_id: Qwen/Qwen2.5-9B-Instruct
  chatter:
    path: /home/james/kinver-hub/models/DeepSeek-R1-Distill-Qwen-3B-Q4_K_M.gguf
    hf_model_id: deepseek-ai/DeepSeek-R1-Distill-Qwen-3B
  frontdesk:
    path: /home/james/kinver-hub/models/qwen25-3b-instruct-q5_k_m.gguf
    hf_model_id: Qwen/Qwen2.5-3B-Instruct
  lifeboat:
    path: /home/james/kinver-hub/models/llama-3.2-3b-instruct-q4_k_m.gguf
...
- [ ] Confirm the `gguf` package exposes the arch-keyed context length via
  ...
  under `/home/james/kinver-hub/models/`.
